...
BASE_APP = dict(
    ...
    icon="",
    logout_url="https://auth.cern.ch/auth/realms/cernn/protocol/"
               "openid-connect/logout",
    params=dict(
        base_url="https://auth.cern.ch/auth/realms/cernn", # test changes
        request_token_url=None,
        access_token_url="https://auth.cern.ch/auth/realms/cernn/protocol/"
                         "openid-connect/token",
        access_token_method="POST",
        authorize_url="https://auth.cern.ch/auth/realms/cernn/protocol/"
                      "openid-connect/auth",
...
OAUTHCLIENT_CERN_OPENID_USERINFO_URL = (
    "https://auth.cern.ch/auth/realms/cernn/protocol/openid-connect/userinfo"
)
