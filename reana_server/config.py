...
# Import invenvio oauth client from local to be able to change source code
# import sys
# sys.path.append('../../../invenio-oauthclient')
...
""" helper = k.KeycloakSettingsHelper(
    ...
    realm_name="", # does not exist for IAM - hardcode URLs w/o realm!?
)
